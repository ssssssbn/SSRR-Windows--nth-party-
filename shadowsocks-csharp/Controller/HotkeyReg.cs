...
namespace Shadowsocks.Controller
{
    static class HotkeyReg
    {
        public static void RegAllHotkeys()
        {
            ...
            if (RegHotkeyFromString(hotkeyConfig.SwitchProxyMode, "SwitchProxyModeCallback")
                && RegHotkeyFromString(hotkeyConfig.SwitchLoadBalance, "SwitchLoadBalanceCallback")
                && RegHotkeyFromString(hotkeyConfig.SwitchAllowLan, "SwitchAllowLanCallback")
                && RegHotkeyFromString(hotkeyConfig.CallClipboardAndQRCodeScanning, "ClipboardAndQRCodeScanningCallback")
            ...
            {
                RegHotkeyFromString("", "SwitchProxyModeCallback");
                RegHotkeyFromString("", "SwitchLoadBalanceCallback");
                RegHotkeyFromString("", "SwitchAllowLanCallback");
                RegHotkeyFromString("", "ClipboardAndQRCodeScanningCallback");
